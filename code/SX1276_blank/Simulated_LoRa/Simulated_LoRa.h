...
//int LORA_SF_NO1													 				=12;				// spread factor
//int LORA_CR_NO1																	=1;				// coding rate [1:4/5, 2:4/6, 3:4/7,  4:4/8]
//int LORA_HAS_CRC_NO1														=1;		// true or false
//int LORA_IMPL_HEAD_NO1													=0;		// true or false
//int LORA_LOWDATERATEOPTIMIZE_NO1								=1;		// true or false
