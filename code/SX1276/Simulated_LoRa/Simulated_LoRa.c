...
//uint32_t Input_Freq_temp_No1[ LORA_TOTAL_LENGTH_NO1 ][( 1 << LORA_SF_NO1 )]={0};
...
//	uint32_t Chirp_Time_Record_No2[LORA_TOTAL_LENGTH_NO2] = {0};
	...
	while( Chirp_Count_No2 < LORA_TOTAL_LENGTH_NO2 )
	{
															...
															LORA_PAYLOAD_LENGTH_NO1 )
		{
			...
			Init_Frequency_Begin_Point_No1 = RF_FREQUENCY + LoRa_Payload_Start_Freq_No1[ Chirp_Status_No1 - LORA_PREAMBLE_LENGTH_NO1 - \
																...
																LORA_QUARTER_SFD_LENGTH_NO2 + LORA_PAYLOAD_LENGTH_NO2 )
		{
			...
			Init_Frequency_Begin_Point_No2 = RF_FREQUENCY + LoRa_Payload_Start_Freq_No2[ Chirp_Status_No2 - LORA_PREAMBLE_LENGTH_NO2 \
		...
		while(1)  // generate symbol
		{
			...
			switch (Chirp_Status_No1)
			{
				...
				{
					Chip_Position_No1 = (int)((Comped_Time - Chirp_Count_No1 * LORA_SYMBOL_TIME_NO1 ) >> 3);
					Input_Freq = (int)(Init_Frequency_Begin_Point_No1 - Chip_Position_No1 * LORA_FREQ_STEP_NO1);
					break;
				}
				case Quarter_SFD:
				{
...
//			Input_Freq_temp_No1[ Chirp_Count_No1 ] [ Chip_Count_No1[Chirp_Count_No1]] = Input_Freq;
			...
			switch (Chirp_Status_No2)
			{
				...
				{
					Chip_Position_No2 = (int)((Comped_Time - Chirp_Count_No2 * LORA_SYMBOL_TIME_NO2 ) >> 3);
					Input_Freq = (int)(Init_Frequency_Begin_Point_No2 - Chip_Position_No2 * LORA_FREQ_STEP_NO2);
					break;
				}
				case Quarter_SFD:
				{
