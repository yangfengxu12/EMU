	...
	while( Chirp_Count_No1 < LORA_TOTAL_LENGTH_NO1)
	{
		while(Comped_Time < Symbol_End_Time_No1[Chirp_Count_No1])  // generate symbol
		{
			...
			if((Chirp_Count_No1>LORA_PREAMBLE_LENGTH_NO1+LORA_ID_LENGTH_NO1+LORA_SFD_LENGTH_NO1+LORA_QUARTER_SFD_LENGTH_NO1-1))
			{
				...
				//any position
//				if(Comped_Time > (Symbol_End_Time_No1[Chirp_Count_No1] -10 -(blank_res+0.85)*chirp_time) &&
//						(Comped_Time < Symbol_End_Time_No1[Chirp_Count_No1]-10 - 0.85*chirp_time)
//					)
//				{
//					LL_GPIO_ResetOutputPin(GPIOB,GPIO_PIN_5);
//					if (LORA_SF_NO1 != 7)
...
//					SX1276SetOpMode(RF_OPMODE_TRANSMITTER);
//					}
//					while(Comped_Time < Symbol_End_Time_No1[Chirp_Count_No1]-10 - 0.85*chirp_time);
//					LL_GPIO_SetOutputPin(GPIOB,GPIO_PIN_5);
////					goto Symbol_End;
//				}
...
//					SX1276SetOpMode( RF_OPMODE_STANDBY );
//					Fast_SetChannel( LoRa_Start_Freq_No1[Chirp_Count_No1+1] );
//					while(Comped_Time < Symbol_End_Time_No1[Chirp_Count_No1]-140);
//					SX1276SetOpMode( RF_OPMODE_SYNTHESIZER_TX );
//					delay_us(3);
//					SX1276SetOpMode(RF_OPMODE_TRANSMITTER);
//					delay_us(3);
//					while(Comped_Time < Symbol_End_Time_No1[Chirp_Count_No1]);
////					temp[Chirp_Count_No1] = Comped_Time;
//					LL_GPIO_SetOutputPin(GPIOB,GPIO_PIN_5);
//					
//					goto Symbol_End;
//				}
