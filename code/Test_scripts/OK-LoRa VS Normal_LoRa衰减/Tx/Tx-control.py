...
# code version
Version_Tx = 0.1
fixed_path = "/home/yfx/test_data/sensitivity/OK-LoRa/Tx/"
...
with open(fixed_path+csv_file_name,'w',newline='') as f:
    ...
    tx_file.writerow([])
    tx_file.writerow(['payload times',  packets_times ])
    tx_file.writerow(['payload length',  payload_length ])
    
    tx_file.writerow(['payload data (hex)'])
    # tx_file.writerow(['payload data (hex)'])
