...
void CC1125_Reg_Init()
{
    ...
    // TX Power = 15 
    // Whitening = false 
    CC1125_Single_Write(REG_IOCFG3,0xB0);            //GPIO3 IO Pin Configuration
    ...
    CC1125_Single_Write(REG_AGC_CS_THR,0x0C);        //Carrier Sense Threshold Configuration
    ...
    CC1125_Single_Write(REG_SETTLING_CFG,0x0B);      //Frequency Synthesizer Calibration and Settling Con..
    CC1125_Single_Write(REG_FS_CFG,0x14);            //Frequency Synthesizer Configuration
    CC1125_Single_Write(REG_WOR_CFG0,0x20);          //eWOR Configuration Reg. 0
    CC1125_Single_Write(REG_WOR_EVENT0_LSB,0x3C);    //Event 0 Configuration LSB
    ...
    CC1125_Single_Write(REG_RFEND_CFG0,0x09);        //RFEND Configuration Reg. 0
    ...
    CC1125_Single_Write(REG_CFM_DATA_CFG,0x01);      //Custom frequency modulation enable
    CC1125_Single_Write(REG_FREQ2,0x56);             //Frequency Configuration [23:16]
    CC1125_Single_Write(REG_FREQ1,0x99);             //Frequency Configuration [15:8]
    CC1125_Single_Write(REG_FREQ0,0x98);             //Frequency Configuration [7:0]
