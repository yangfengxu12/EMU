...
void CC1125_Reg_Init()
{
    ...
    CC1125_Single_Write(REG_MODCFG_DEV_E,0x1B);      //Modulation Format and Frequency Deviation Configur..
    CC1125_Single_Write(REG_MDMCFG1,0x06);           //General Modem Parameter Configuration Reg. 1
    CC1125_Single_Write(REG_MDMCFG0,0x4D);           //General Modem Parameter Configuration Reg. 0
    CC1125_Single_Write(REG_FS_CFG,0x04);            //Frequency Synthesizer Configuration
    ...
    CC1125_Single_Write(REG_PA_CFG2,0x29);           //Power Amplifier Configuration Reg. 2
    CC1125_Single_Write(REG_PA_CFG0,0x54);           //Power Amplifier Configuration Reg. 0
